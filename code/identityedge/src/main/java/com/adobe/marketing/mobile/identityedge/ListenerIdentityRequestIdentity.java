...
class ListenerIdentityRequestIdentity extends ExtensionListener {
     ...
     */
    ListenerIdentityRequestIdentity(final ExtensionApi extensionApi, final String type, final String source) {
    ...
    public void hear(final Event event) {
        if (event == null || event.getEventData() == null) {
            MobileCore.log(LoggingMode.DEBUG, IdentityEdgeConstants.LOG_TAG, "Event or Event data is null. Ignoring the event listened by ListenerIdentityRequestIdentity");
            return;
        }
